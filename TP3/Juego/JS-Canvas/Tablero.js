class Tablero {
    ...
    draw() {
        ...
        this.context.fillRect(((canvasWidth-this.columnas*this.sizeFicha*2.75)/2)-15, this.getSuperior(), this.columnas*this.sizeFicha*2.75+30, this.filas*this.sizeFicha*2.75);
        this.context.globalCompositeOperation = "source-in";
        let zoom = (54/this.sizeFicha);
        const width = ((this.columnas*this.sizeFicha*2.75)*zoom)+100;
        const height = (this.filas*this.sizeFicha*2.75)*zoom;
        this.context.drawImage(this.image, ((canvasWidth-width)/2)-20, this.getSuperior()-(height/4), width, height);
        this.context.strokeStyle = this.getGradient();
        this.context.lineWidth = 5;
        this.context.globalCompositeOperation = "source-over";
        this.context.strokeRect(((canvasWidth-this.columnas*this.sizeFicha*2.75)/2)-15, this.getSuperior(), this.columnas*this.sizeFicha*2.75+30, this.filas*this.sizeFicha*2.75);
        this.drawPosiciones();
    }
}